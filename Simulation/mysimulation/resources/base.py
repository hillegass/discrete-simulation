"""
Base classes of for mysimulation's shared resource types.
...
from mysimulation.events import Event
...
class Put(Event):
    ...
    request if an exception (like an :class:`mysimulation.events.Interrupt` for
    example) occurs:
    ...
    def cancel(self):
        ...
        :class:`~mysimulation.events.Interrupt`.
