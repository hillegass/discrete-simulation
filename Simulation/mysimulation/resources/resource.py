...
"""
from mysimulation.core import BoundClass
from mysimulation.resources import base


class Preempted(object):
    """Cause of an preemption :class:`~mysimulation.events.Interrupt` containing
    information about the preemption.

    """
    def __init__(self, by, usage_since, resource):
        self.by = by
        """The preempting :class:`mysimulation.events.Process`."""
...
class Request(base.Put):
    ...
    granted. Subclass of :class:`mysimulation.resources.base.Put`.
...
class Release(base.Get):
    ...
    triggered immediately. Subclass of :class:`mysimulation.resources.base.Get`.
...
class Resource(base.BaseResource):
    ...
    The *env* parameter is the :class:`~mysimulation.core.Environment` instance the
    ...
    def __init__(self, env, capacity=1):
        ...
        :attr:`~mysimulation.resources.base.BaseResource.put_queue`.
        """
...
class PriorityResource(Resource):
    """A :class:`~mysimulation.resources.resource.Resource` supporting prioritized
    requests.
    ...
    :attr:`~mysimulation.resources.base.BaseResource.put_queue` for details."""
    GetQueue = list
    """Type of the get queue. See
    :attr:`~mysimulation.resources.base.BaseResource.get_queue` for details."""
...
class PreemptiveResource(PriorityResource):
    """A :class:`~mysimulation.resources.resource.PriorityResource` with preemption.

    If a request is preempted, the process of that request will receive an
    :class:`~mysimulation.events.Interrupt` with a :class:`Preempted` instance as
    cause.
